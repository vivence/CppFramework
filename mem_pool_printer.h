...
void mem_pool_printer::_print_global_info(std::ostream& out)
{
    ...
    out << " ** min_cell: " << "size = " << string_format_utils::format_size(_M::info_for_global::min_cell_size) << ", count = " << string_format_utils::format_count(_M::info_for_global::min_cell_count) << std::endl;
    out << " ** max_cell: " << "size = " << string_format_utils::format_size(_M::info_for_global::max_cell_size) << ", count = " << string_format_utils::format_count(_M::info_for_global::max_cell_count) << std::endl;
    out << "-------------------------------------------------<" << std::endl;
}
...
static void mem_pool_printer::_print_type_info(std::ostream& out)
{
    ...
    out << " ** cell_raw_size: " << string_format_utils::format_size(_M::template info_for_type<_T>::cell_raw_size) << std::endl;
